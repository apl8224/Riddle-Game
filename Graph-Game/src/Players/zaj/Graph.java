package Players.zaj;
/*
 * adapted from csci142 graphs lecture
 */
import java.util.*;
...
public interface Graph< Node > {
     ...
     */
    public String getNodeCoords( Node node );
     ...
     * @param coordinates the name of the new node
     * @return the Node object created
     */
    public void addNewNode( String coordinates, int id );
